...
# Admin user IDs
admin_id = ["6762572471","1209168143","1901192720"]
    ...
    if user_id in admin_id:
        ...
        if len(command) > 2:
            ...
            if user_to_add not in allowed_user_ids:
                ...
                response = "User already add panitaya 😂."
        else:
            response = "Please specify a user ID and the duration (e.g., 1hour, 2days, 3weeks, 4months) to add ✍️."
    else:
        response = "You have not purchased yet purchase now from:- VIP DDOS."
...
def show_all_users(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- VIP DDOS ❄."
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- VIP DDOS")
...
Buy From :- VIP DDOS
Official Channel :- POWER FULL DDOS
'''
